...
## 6. OTP Endpoint
All send-OTP flows use `https://nyservices.nirvaanayoga.com:8443/api/v1/otp/send-otp`. Update `src/constants.ts` if the backend changes so every feature picks up the same URL automatically.
